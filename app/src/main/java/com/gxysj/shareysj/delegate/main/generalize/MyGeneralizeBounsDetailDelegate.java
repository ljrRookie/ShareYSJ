...
public class MyGeneralizeBounsDetailDelegate extends YSJDelegate {
    ...
    public Object setLayout() {
        return R.layout.delegate_generalize_bouns_detail;
    }

    @Override
    public void onBindView(@Nullable Bundle savedInstanceState, @NonNull View rootView) {
        mTvTitle.setText("奖金明细");
        initRecyclerView();
        initData();
    ...
    private void initData() {
        ...
        RequestCenter.GetUserBonusDetailedList(requestParams, new DisposeDataListener() {
            @Override
