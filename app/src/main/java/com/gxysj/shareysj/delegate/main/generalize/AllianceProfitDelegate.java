...
public class AllianceProfitDelegate extends YSJDelegate {
    ...
    public void onBindView(@Nullable Bundle savedInstanceState, @NonNull View rootView) {
        mTvTitle.setText("分红明细");
        mTvEmpty.setText("暂无分红明细~");
        initRecyclerView();
        initData();
    }
    private void initData() {
        ...
        RequestCenter.GetUserBonusDetailed(requestParams, new DisposeDataListener() {
            @Override
