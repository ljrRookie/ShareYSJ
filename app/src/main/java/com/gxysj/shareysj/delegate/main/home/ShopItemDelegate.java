...
public class ShopItemDelegate extends YSJDelegate implements ShopCartInterface, ShopCartItemInterface {
    ...
    public Object setLayout() {
        return R.layout.delegate_home_shop_item;
    }
    ...
    private void initData() {
        ...
        RequestCenter.GetMachineCommodityList(requestParams, new DisposeDataListener() {
            ...
            public void onSuccess(Object responseObj) {
                final MachineGoodBean data = (MachineGoodBean) responseObj;
                    ...
                    mShopAdapter.setOnItemClickListener(new BaseQuickAdapter.OnItemClickListener() {
                        ...
                        public void onItemClick(BaseQuickAdapter adapter, View view, int position) {
                            ...
                            if(Integer.parseInt(stock)>0){
                                ...
                                RxToast.normal("此商品已卖完，请选择另一件商品");
                            }

                        }
                    });
                    mShopAdapter.openLoadAnimation();
                    mShopAdapter.setShopCartInterface(ShopItemDelegate.this);
    ...
    public static ShopItemDelegate create(String code) {
        ShopItemDelegate shoppingDelegate = new ShopItemDelegate();
