...
public class OpenLocalMapUtil {
     ...
     * @return
     */
    public static String getBaiduMapUri(double originLat, double originLon, String originName, double desLat, double desLon, String destination, String region, String src){
        String uri = "http://api.map.baidu.com/direction?origin=latlng:%1$s,%2$s|name:%3$s" +
                "&destination=latlng:%4$s,%5$s|name:%6$s&mode=driving&region=%7$s&output=html&src=%8$s";
               /* "#Intent;" +
